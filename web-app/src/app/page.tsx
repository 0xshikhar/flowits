    ...
    <main className="min-h-screen p-6 md:p-10">
      ...
      <section className="max-w-6xl mx-auto mb-12">
        <div className="text-center space-y-6 animate-fade-in">
          <div className="inline-block">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-[#00EF8C] text-black font-semibold text-sm">
              <Zap className="h-4 w-4 text-[#00EF8C]" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Link href="/feed">
              <Button size="lg" className="text-lg px-8 py-6 bg-[#00EF8C] hover:bg-[#00D67D] text-black font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                Start Predicting
      ...
      <section className="max-w-6xl mx-auto mb-12">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="block-card p-8 hover-lift">
            <div className="h-12 w-12 bg-[#00EF8C] flex items-center justify-center mb-4">
      ...
      <section className="max-w-6xl mx-auto">
        <div className="block-card p-12">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[#00EF8C] mb-2">$2.5M+</div>
              <div className="text-muted-foreground">Total Volume</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#00EF8C] mb-2">15K+</div>
              <div className="text-muted-foreground">Active Users</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#00EF8C] mb-2">500+</div>
              <div className="text-muted-foreground">Markets Created</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#00EF8C] mb-2">98%</div>
